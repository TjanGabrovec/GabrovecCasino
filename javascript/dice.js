document.addEventListener('DOMContentLoaded', () => {
    ...
    let players = [];
    let isRolling = false;
    let highestScore = 0;  // Track highest score across all players
    ...
    function initGame() {
        ...
        if (playersData) {
            ...
            if (players.length === 3) {
                ...
                updateHighestScoreDisplay();  // Initialize highest score display
                return;
            }
        }
    ...
    async function rollAllDice() {
        ...
        // Calculate and store score for current player
        const currentScore = die1 + die2 + die3;
        players[currentPlayerIndex].score = currentScore;
        
        // Update sessionStorage with new scores
    ...
    function determineWinner() {
        ...
        // Display winner with save option
        Swal.fire({
            title: 'Game Over!',
            ...
            if (result.dismiss === Swal.DismissReason.cancel || result.isDenied) {
                // Redirect to index.php after saving or exiting
